...
= {back-btn} Wołowina po burgundzku 🥩 {toggle-switch}
...
Po ponownym zagotowaniu przykryć naczynie i wstawić do nagrzanego do 150 stopni C piekarnika. Zapiekać przez ok. 2 i ½ godziny.
