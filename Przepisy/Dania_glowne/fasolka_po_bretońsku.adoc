...
= {back-btn} Fasolka po bretońsku 🐖 {toggle-switch}
...
Następnego dnia odcedzić, wlać 1 litr świeżej wody, dodać 1 łyżeczkę soli, ziele angielskie i liść laurowy i gotować pod przykryciem przez około 1 i ½ godziny do miękkości.
