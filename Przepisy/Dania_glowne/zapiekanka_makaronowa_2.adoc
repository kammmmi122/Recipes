...
= {back-btn} Zapiekanka makaronowa 2 🐔 {toggle-switch}
...
* 150 g mozzarelli
* przyprawy: 1 łyżeczka oregano, 2 łyżeczki przyprawy curry, 1 łyżeczka papryki, ⅓ łyżeczki ostrej papryki, ½ łyżeczki kurkumy
