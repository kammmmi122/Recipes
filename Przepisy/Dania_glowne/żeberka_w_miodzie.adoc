...
= {back-btn} Żeberka w miodzie 🐖 {toggle-switch}
...
* 1 średnia cebula
* 1 średnia papryka
* ⅓ szklanki wody, bulionu lub piwa
* 4 łyżki oleju
...
Do naczynia wlej na koniec około ⅓ szklanki dowolnego bulionu lub też jasnego albo ciemnego piwa. Możesz też wlać samą wodę lub nawet sok wyciśnięty z jednej dużej pomarańczy.
