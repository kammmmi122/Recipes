= +++<a href="../../index.html" class="back-to-home-btn">← Wróć do przepisów</a>+++ Domowa pizza 2 +++ <label class="switch"><input data-status="off" type="checkbox"><span class="slider round"></span></label>+++
