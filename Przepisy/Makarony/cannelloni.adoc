...
= {back-btn} Cannelloni 🥩 {toggle-switch}
...
* ½ łyżeczki suszonego oregano (opcjonalnie)
* 30 g masła
* 2 łyżki mąki
* 300 ml mleka
...
Przesunąć wszystko na bok garnka i partiami wkładać mięso: włożyć ⅓ część mięsa i dokładnie obsmażyć mieszając co chwilę, aż zmieni kolor z czerwonego na brązowy. Następnie wymieszać z warzywami i boczkiem, przesunąć na bok, powtórzyć z resztą mięsa.
