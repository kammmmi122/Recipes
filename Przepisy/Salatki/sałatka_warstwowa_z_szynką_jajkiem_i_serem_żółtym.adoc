= Sałatka warstwowa z szynką, jajkiem i serem żółtym +++ <label class="switch"><input data-status="off" type="checkbox"><span class="slider round"></span></label>+++ , jajkiem i serem żółtym
