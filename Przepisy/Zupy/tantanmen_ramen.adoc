= +++<a href="../../index.html" class="back-to-home-btn">← Wróć do przepisów</a>+++ Tantanmen ramen 🐖 +++ <label class="switch"><input data-status="off" type="checkbox"><span class="slider round"></span></label>+++
...
* ¼ szklanki mirinu (lub białego wina + ½ łyżeczki cukru)
...
* Przepisy/Przystawki/nitamago.html[4 jajka nitamago]
