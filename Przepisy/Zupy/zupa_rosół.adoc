...
= {back-btn} Zupa rosół 🐔 {toggle-switch}
...
Po zagotowaniu zmniejszyć ogień i zszumować wywar. Zmniejszyć ogień i gotować na małym ogniu (rosół ma tylko "mrugać") pod lekko uchyloną pokrywą przez około 1 i ½ godziny.
...
Warzywa włożyć do rosołu i zagotować. Dodać przyprawy: ziele angielskie, liść laurowy i czarny pieprz. Zmniejszyć ogień i gotować na małym ogniu przez około 1 godzinę lub do 1 i ½ godziny.
