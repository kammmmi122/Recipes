...
= {back-btn} Hiszpańska zupa z ciecierzycy 🌱 {toggle-switch}
...
* komosa ryżowa (najlepiej czerwona) - ½ szklanki (100 g)
* oliwa z oliwek - 1 łyżka (10 g)
* przyprawy: 2 zabki czosnku, ½ małej papryczki chili świeżej, ½ łyżeczki kminu rzymskiego mielonego, 1//3 łyżeczki kolendry mielonej, 1 łyżeczka papryki słodkiej, ½ łyżeczki papryki wędzonej, sok z limonki, sól i pieprz czarny do smaku
